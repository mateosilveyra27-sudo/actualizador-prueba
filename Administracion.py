...
def comprobar_actualizacion(parent):
    """Comprueba administracion_version.txt en GitHub y, con confirmacion, inicia el reemplazo por .bat."""
    try:
        ...
        QMessageBox.critical(
            ...
            f"No se pudo leer administracion_version.txt en GitHub (HTTP {e.code}).\n\n"
